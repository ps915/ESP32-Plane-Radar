...
/** Per-manufacturer aircraft colours (see aircraft::classify). */
constexpr uint8_t kAcAirbusR = 0;
constexpr uint8_t kAcAirbusG = 90;
constexpr uint8_t kAcAirbusB = 255;
constexpr uint8_t kAcBoeingR = 255;
constexpr uint8_t kAcBoeingG = 30;
constexpr uint8_t kAcBoeingB = 30;
constexpr uint8_t kAcBelugaR = 255;
constexpr uint8_t kAcBelugaG = 190;
constexpr uint8_t kAcBelugaB = 0;
constexpr uint8_t kAcOtherR = 200;
constexpr uint8_t kAcOtherG = 120;
constexpr uint8_t kAcOtherB = 255;
